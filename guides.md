...
See the [`python install`](about:blank/concepts/python-versions/#installing-a-python-version) documentation
for more details.
...
See the [`python list`](about:blank/concepts/python-versions/#viewing-available-python-versions)
...
Automatic Python downloads can be [easily disabled](about:blank/concepts/python-versions/#disabling-automatic-python-downloads) if you want more control over when Python is downloaded.
...
[Python discovery](about:blank/concepts/python-versions/#discovery-of-python-versions) documentation for
details.

To force uv to use the system Python, provide the `--no-managed-python` flag. See the
[Python version preference](about:blank/concepts/python-versions/#requiring-or-disabling-managed-python-versions)
documentation for more details.
...
Support for upgrading Python patch versions is in *preview*. This means the behavior is
...
See the [`python upgrade`](about:blank/concepts/python-versions/#upgrading-python-versions) documentation
for more details.

## [Next steps](#next-steps)

To learn more about `uv python`, see the [Python version concept](../../concepts/python-versions/)
page and the [command reference](about:blank/reference/cli/#uv-python).
